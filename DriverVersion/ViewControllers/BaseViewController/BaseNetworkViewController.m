...
- (void)gotoLoginViewController{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (rootVC.presentedViewController) {
            ...
            [rootVC presentViewController:loginVC animated:false completion:nil];
        }
...
//        url = [UrlManager getRequestUrlByMethodName:urlMethodName];
    ...
    [requestParameterDic addEntriesFromDictionary:@{@"apiCode":urlMethodName}];
    if (!parameterDic) {
        [requestParameterDic addEntriesFromDictionary:@{}];
    }else{ 
        [requestParameterDic addEntriesFromDictionary:parameterDic];
    ...
    [[NetRequestManager sharedInstance] sendRequest:url parameterDic:!isGETRequest ? jsonParameterDic : nil requestHeaders:headers requestMethodType:methodType requestTag:tag delegate:delegate userInfo:userInfo];
}
