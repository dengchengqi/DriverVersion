...
- (void)configTableView{
    ...
    self.view.backgroundColor = project_view_background_color;
...
- (NSAttributedString *)descriptionForEmptyDataSet:(UIScrollView *)scrollView
{
    ...
    NSDictionary *attributes = @{NSFontAttributeName: [self getDescriptionTextFont],
                                 NSForegroundColorAttributeName: [self getDescriptionTextColor],
                                 NSParagraphStyleAttributeName: paragraph};
    
    return [[NSAttributedString alloc] initWithString:text attributes:attributes];
}
- (UIColor *)getDescriptionTextColor{
    return project_textgray_gray;
}
