...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell == nil) {
        ...
        [cell.textLabel setFont:self.textLabelFont?self.textLabelFont: [UIFont systemFontOfSize:BUTTON_FONT_SIZE]];
        [cell.textLabel setTextAlignment:NSTextAlignmentCenter];
    }
    
    if (self.destructiveButtonTitle) {
        if (indexPath.row == 0) {
            [cell.textLabel setTextColor:self.titleColor ? self.titleColor:COLOR_DESTRUCTIVE_TITLE];
            [cell.textLabel setText:self.destructiveButtonTitle];
        }
        else {
            [cell.textLabel setTextColor:self.textColor ? self.textColor:[UIColor blackColor]];
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        [_tableView setSeparatorColor:self.separatorLineColor?self.separatorLineColor: [UIColor colorWithWhite:0.5 alpha:0.3]];
...
- (UIButton *)cancelButton{
    if (_cancelButton == nil) {
        ...
        [_cancelButton setTitleColor:self.cancelBtnColor ? self.cancelBtnColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_cancelButton.titleLabel setFont:self.cancelBtnFont?self.cancelBtnFont:[UIFont systemFontOfSize:BUTTON_FONT_SIZE]];
