...
- (UIView *)contentView {
    if (!_contentView) {
        ...
        [_contentView setBackgroundColor:tn_background_gray];
...
- (TNTabbar *)tabBar {
    if(!_tabBar){
        ...
        _tabBar.backgroundColor= UIColorFromRGB(0x353535);
...
- (UIViewController *)selectedViewController {
    return [self.viewcontrollerArray objectAtIndex:[self selectedIndex]];
}
