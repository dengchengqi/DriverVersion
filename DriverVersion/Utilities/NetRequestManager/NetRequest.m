...
- (void)cacheResponseObject:(NSDictionary *)responseObject{
    ...
    {
        NSData * responseObjectData = [NSJSONSerialization dataWithJSONObject:responseObject[@"info"] options:NSJSONWritingPrettyPrinted error:nil];
...
- (BOOL)isParseSuccessWithResponseData:(NSDictionary *)responseObject result:(id *)result
{
    ...
    *result = responseObject;
    ...
    if (![*result objectForKey:ERRORKEY]) {
         return NO;
    }
    NSNumber *myCodeNum ;
    NSString *myMsgStr;
...
//    }
    ...
    if ([*result objectForKey:ERRORKEY] &&![[*result objectForKey:ERRORKEY] isKindOfClass:[NSNull class]]) {
        myCodeNum = [*result objectForKey:ERRORKEY];
    }
    
    if ([*result objectForKey:INFOKEY] &&![[*result objectForKey:INFOKEY] isKindOfClass:[NSNull class]]) {
        myMsgStr = [*result objectForKey:INFOKEY];
    }
