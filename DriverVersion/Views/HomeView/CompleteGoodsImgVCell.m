...
@interface CompleteGoodsImgVCell()
@property(nonatomic, strong)UIImageView * image;
@end
@implementation CompleteGoodsImgVCell
...
//        [_deleteBtn setImage:[UIImage imageNamed:@"homework_voice_close"] forState:UIControlStateNormal];
        _deleteBtn.frame = CGRectMake(self.tz_width - 36, 0, 36, 36);
//        _deleteBtn.imageEdgeInsets = UIEdgeInsetsMake(-10, 0, 0, -10);
       
       [self  addSubview:_deleteBtn];
        _image = [[UIImageView alloc]initWithFrame:CGRectMake(self.tz_width - 18, 0, 18, 18)];
        _image.image = [UIImage imageNamed:@"guanbi"];
